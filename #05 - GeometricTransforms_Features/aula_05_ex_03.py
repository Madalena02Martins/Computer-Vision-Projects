...
imageAFilter3x3_1 = cv2.medianBlur(resized_image,3)
imageAFilter5x5_1 = cv2.medianBlur(resized_image,5)
imageAFilter7x7_1 = cv2.medianBlur(resized_image,7)

imageAFilter3x3_2 = cv2.medianBlur(imageAFilter3x3_1,3)
imageAFilter5x5_2 = cv2.medianBlur(imageAFilter5x5_1,5)
imageAFilter7x7_2 = cv2.medianBlur(imageAFilter7x7_1,7)

imageAFilter3x3_3 = cv2.medianBlur(imageAFilter3x3_2,3)
imageAFilter5x5_3 = cv2.medianBlur(imageAFilter5x5_2,5)
imageAFilter7x7_3 = cv2.medianBlur(imageAFilter7x7_2,7)
