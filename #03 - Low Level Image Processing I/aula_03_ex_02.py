...
image = cv2.imread( "./images/ireland-06-05.tif", cv2.IMREAD_UNCHANGED)
...
cv2.imshow('colorhist', histImage)#histograma a preto
cv2.waitKey(0)

##########################
# Drawing using matplotlib
plt.plot(hist_item,'r')#histograma a vermelho
plt.xlim(histRange)
plt.show()