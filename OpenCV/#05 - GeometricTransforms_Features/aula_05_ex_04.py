...
scale_percent = 40  # Percentual do redimensionamento # 40% para Lena_Ruido.png e DETI_Ruido.png, restantes 70%
...
imageAFilter3x3_1 = cv2.GaussianBlur(resized_image,(3,3),0)
imageAFilter5x5_1 = cv2.GaussianBlur(resized_image,(5,5),0)
imageAFilter7x7_1 = cv2.GaussianBlur(resized_image,(7,7),0)

imageAFilter3x3_2 = cv2.GaussianBlur(imageAFilter3x3_1,(3,3),0)
imageAFilter5x5_2 = cv2.GaussianBlur(imageAFilter5x5_1,(5,5),0)
imageAFilter7x7_2 = cv2.GaussianBlur(imageAFilter7x7_1,(7,7),0)

imageAFilter3x3_3 = cv2.GaussianBlur(imageAFilter3x3_2,(3,3),0)
imageAFilter5x5_3 = cv2.GaussianBlur(imageAFilter5x5_2,(5,5),0)
imageAFilter7x7_3 = cv2.GaussianBlur(imageAFilter7x7_2,(7,7),0)
